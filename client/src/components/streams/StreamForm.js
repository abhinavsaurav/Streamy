...
class StreamForm extends React.Component {
	...
	//this
	onSubmit = (formValues) => {
		// making the prop onSubmit as generalized so can be used with other call back function
	...
	render() {
		...
		// label is a prop
		return (
			// on passing the prop the handleSubmit handles the form events and after its done then our callback gets invoked
